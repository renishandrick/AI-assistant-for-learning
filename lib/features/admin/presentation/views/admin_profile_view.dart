...
/// Admin Profile View - Same as SuperAdmin but shows "Admin" role
...
class _AdminProfileViewState extends State<AdminProfileView> {
  ...
  String get _userName => _profile?['full_name'] ?? 'Admin';
          ...
          : SingleChildScrollView(
              ...
              child: Column(
                children: [
                  ...
                  // Permissions Section (Admin - no 'Create Admins')
                  GlassContainer(
                    borderRadius: BorderRadius.circular(20),
                    blur: 10,
                    opacity: 0.05,
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(color: AppPallete.secondary, width: 3),
              boxShadow: [
                BoxShadow(
                  color: AppPallete.secondary.withValues(alpha: 0.3),
                  blurRadius: 20,
                  spreadRadius: 2,
                ),
              ],
    ...
    return Row(
      children: [
        Container(
          ...
          child: Icon(icon, color: AppPallete.secondary, size: 20),
        ),
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          Text(permission, style: const TextStyle(color: AppPallete.textPrimary)),
        ],
      ),
    );
  }
